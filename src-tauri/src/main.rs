...
async fn main() {
	...
	let app = match Builder::default()
		.invoke_handler(tauri::generate_handler![
			...
			frontend::pages::remove_page,
			frontend::pages::move_page,
			...
			frontend::sheets::list_sheet_templates,
			frontend::sheets::save_current_page_as_sheet_template,
			frontend::sheets::delete_sheet_template,
			frontend::sheets::rename_sheet_template,
			frontend::sheets::duplicate_sheet_template,
			frontend::sheets::apply_sheet_template,
			frontend::sheets::insert_sheet_template_as_new_page,
